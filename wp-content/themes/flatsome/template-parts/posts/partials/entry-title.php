...
if ( is_single() ) :
	if ( get_theme_mod( 'blog_single_header_category', 1 ) ) :
		echo '<img src="https://spa.akgroups.top/wp-content/uploads/2023/11/page-header-s-1.png" alt="404 image" class="page-header__shape">
		<br><h6 class="entry-category is-xsmall">D.D Beauty bar / ';
